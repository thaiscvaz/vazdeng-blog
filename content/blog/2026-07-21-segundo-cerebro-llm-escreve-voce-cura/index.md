...
![O meu segundo cérebro hoje. Cada ponto é uma memória, cada cor é um domínio da minha vida, cada linha é uma conexão. Seis anos de estudo.](images/01-grafo-global.png)
...
![Uma nota minha e as memórias que ela puxa. Eu escrevi cada uma ao longo dos anos. A IA desenhou as ligações que eu tinha esquecido que existiam.](images/02-grafo-hub.png)
...
![Acumular guarda, minerar alcança. As mesmas notas, antes isoladas, depois conectadas pela camada de mineração.](images/00-acumular-minerar.png)
